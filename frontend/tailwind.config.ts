...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'inner-blur':
          'inset -0.5px 0.5px 1px 0px var(--color-cream), inset 0 0 96px 0 rgba(80, 131, 186, 0.08)',
        'inner-blur-light':
          'inset -0.5px 0.5px 1px 0px var(--color-cream), inset 0 0 96px 0 rgba(80, 131, 186, 0.08)',
        ...
        'btn-secondary':
          'inset 0px 1px 0px 0px rgba(255, 255, 255, 0.1), inset 0px 0px 12px 0px rgba(255, 255, 255, 0.08), inset 0px -8px 32px 0px var(--color-carafe), inset -0.5px 0.5px 1px 0px rgba(80, 131, 186, 0.12), inset 0 0 96px 0 rgba(80, 131, 186, 0.05), 0px 0px 0px 1px rgba(255, 255, 255, 0.2), 0px 1px 0px 0px rgba(255, 255, 255, 0.2)',
